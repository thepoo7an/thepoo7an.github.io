...
export const PREFLIGHT_ITEMS: PreFlightItem[] = [
  ...
  },
  {
    ...
    titleEn: 'Visual Style & Mood',
    descFa: 'مشخص کردن حس‌وحال بصری و تم رنگی متناسب با فضا و ژانر موسیقی شما.',
    descEn: 'Preferred visual aesthetic and mood matching your track genre and release vision.',
