...
const METRICS: MetricItem[] = [
  ...
  },
  {
    id: 'm-turnaround',
    value: '۲۴h',
    labelFa: 'میانگین زمان تحویل',
    labelEn: 'Average Turnaround',
    descFa: 'تحویل معمولاً همان روز یا ۲۴ ساعت',
    descEn: 'Same-day or 24-hour typical turnaround',
    icon: Clock,
  },
  {
    id: 'm-speed',
    value: '< ۲h',
    labelFa: 'پاسخگویی در ساعات کاری',
    labelEn: 'Response Time',
    descFa: '۱۰ صبح تا ۱۱ شب در تلگرام و دایرکت',
    descEn: '10 AM–11 PM on Telegram & Direct',
    icon: CheckCircle,
  },
];
